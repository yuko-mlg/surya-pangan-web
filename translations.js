export const translations = {
    id: {
        ...
        "otty.modal.p1.desc": "Membangun hubungan harmonis antar divisi dan mitra guna menciptakan ekosistem kerja yang produktif, di mana setiap pihak saling menguatkan untuk mencapai tujuan bersama.",
        "otty.modal.p2.title": "M - Mandiri",
        "otty.modal.p2.desc": "Memiliki inisiatif tinggi dalam menyelesaikan tantangan bisnis dengan efisien, menunjukkan kedewasaan dalam operasional serta tidak bergantung secara berlebihan pada pihak lain.",
        "otty.modal.p3.title": "A - Andal",
        "otty.modal.p3.desc": "Menjadi mitra yang dapat dipercaya dengan menjaga konsistensi kualitas produk dan ketepatan pelayanan, memastikan kepuasan pelanggan tetap menjadi prioritas utama.",
        "otty.modal.p4.title": "R - Rajin",
        "otty.modal.p4.desc": "Menunjukkan ketekunan dan disiplin tinggi dalam setiap aspek pekerjaan, mulai dari manajemen stok yang rapi hingga kecepatan dalam merespons kebutuhan pasar yang dinamis.",
        "otty.modal.p5.title": "T - Tangguh",
        "otty.modal.p5.desc": "Memiliki daya tahan dan kekuatan dalam menghadapi fluktuasi pasar atau tantangan operasional, tetap berdiri tegak demi menjaga stabilitas pasokan bagi seluruh mitra kuliner.",
    ...
    en: {
        ...
        "about.otty.val1.desc": "Able to cooperate harmoniously.",
        "about.otty.val2.title": "Maintained",
        "about.otty.val2.desc": "Standing tall without excessive dependence.",
        "about.otty.val3.title": "Accountable",
        "about.otty.val3.desc": "Trustworthy and consistent.",
        "about.otty.val4.title": "Reliable",
        "about.otty.val4.desc": "Diligent and disciplined.",
        "about.otty.val5.title": "Tough",
        "about.otty.val5.desc": "Strong in facing challenges.",
        ...
        "otty.modal.p1.desc": "Building harmonious relationships between divisions and partners to create a productive work ecosystem, where every party strengthens each other to achieve common goals.",
        "otty.modal.p2.title": "M - Maintained (Self-Reliant)",
        "otty.modal.p2.desc": "Having high initiative in solving business challenges efficiently, showing operational maturity without excessive dependence on others.",
        "otty.modal.p3.title": "A - Accountable (Reliable)",
        "otty.modal.p3.desc": "Being a trustworthy partner by maintaining product quality consistency and service precision, ensuring customer satisfaction remains the top priority.",
        "otty.modal.p4.title": "R - Reliable (Diligent)",
        "otty.modal.p4.desc": "Showing high perseverance and discipline in every aspect of work, from neat stock management to speed in responding to dynamic market needs.",
        "otty.modal.p5.title": "T - Tough (Resilient)",
        "otty.modal.p5.desc": "Having the endurance and strength to face market fluctuations or operational challenges, standing tall to maintain supply stability for all culinary partners.",
